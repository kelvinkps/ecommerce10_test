    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form class="login-form" action="controller/logar.php" method="post">
                <h3 class="form-title">Acessar a sua conta</h3>
                <?php mostraMensagem(); ?>
                ...
                <div class="forget-password">
                    ...
                    <p> Clique
                        <a href="javascript:;" id="forget-password"> aqui </a> para alterar a sua senha. </p>
                </div>
                <div class="create-account">
                    <p> Ainda não tem uma conta?&nbsp;
                        <a href="cadastrar.php"> Crie uma conta </a>
                    </p>
                </div>
            </form>
            <!-- END LOGIN FORM -->
            ...
            <form class="forget-form" action="index.html" method="post">
                ...
                <p> Entre com o seu endereço de email para trocar a senha. </p>
                <div class="form-group">
                    <div class="input-icon">
